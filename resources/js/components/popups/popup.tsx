...
export default function Popup({ name, children, visible=true, direction, background, className = '', wrapClassName='' }: popupProps) {
	...
	return (
		...
		<section className={popupVariants({ direction, background })}>
			<div className={cn(
				...
				<div className={cn(
					"relative flex-grow-1 overflow-y-auto",
					...
					{/* <div className={cn(
						"w-[100%] h-[100%]",
						"[&]:absolute [&]:z-2 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 overflow-hidden",
					)}>
						<div className="
							[&]:absolute
							[&]:z-2
